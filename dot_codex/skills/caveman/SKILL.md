...
description: >
  ...
  Opt-in only: use when the user explicitly says "caveman", "caveman mode",
  "talk like caveman", "use caveman", or invokes /caveman. Do not auto-trigger
  for generic brevity, terse prose, or token-efficiency requests.
---
